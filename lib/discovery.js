...
class UnifiDeviceDiscovery extends EventEmitter {
    ...
    start(timeout = 3000) {
        ...
        return new Promise((resolve, reject) => {
            let timer = setTimeout(() => {
                ...
                let result = Object.keys(this._devices).map(key => (
                    {
                        name: this._devices[key].hostname,
                        data: this._devices[key]
                    }
                ));
...
module.exports = UnifiDeviceDiscovery;